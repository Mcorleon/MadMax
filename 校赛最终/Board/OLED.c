...
0x00,0x00,0x20,0xA0,0x68,0x3C,0xEA,0x28,0x5C,0x90,0x10,0x00,0x00,0x00,0x00,0x02,
0x01,0x00,0x00,0x15,0x0A,0x05,0x02,0x00,0x01,0x01,0x00,0x00,/*"参",0*/

0x00,0x00,0xA0,0xE8,0x3E,0x28,0x54,0x40,0x30,0xCC,0x20,0x20,0x00,0x00,0x00,0x02,
0x12,0x12,0x0D,0x0E,0x01,0x09,0x06,0x07,0x08,0x08,0x00,0x00,/*"数",1*/

0x00,0x20,0x20,0xE2,0x04,0x00,0xFC,0xD4,0xD4,0xBC,0xB4,0xFE,0x04,0x00,0x00,0x00,
0x00,0x07,0x0A,0x06,0x01,0x01,0x02,0x01,0x0A,0x1F,0x00,0x00,/*"调",2*/

0x00,0x40,0x40,0xE4,0x04,0x00,0x00,0xC2,0x7C,0xA0,0x04,0x00,0x00,0x00,0x00,0x00,
0x00,0x07,0x04,0x04,0x07,0x04,0x02,0x03,0x04,0x08,0x1C,0x00,/*"试",3*/


0x00,0x00,0x80,0x80,0xD8,0x5E,0xF4,0x5C,0xD7,0x64,0x44,0x40,0x40,0x00,0x00,0x00,
0x04,0x04,0x05,0x05,0x1F,0x05,0x05,0x05,0x03,0x00,0x00,0x00,/*"華",0*/

0x80,0x40,0x30,0xCC,0x84,0x50,0xF4,0x4C,0x7A,0x2A,0x68,0x40,0x40,0x00,0x00,0x00,
0x0F,0x00,0x09,0x06,0x07,0x0B,0x07,0x05,0x1F,0x00,0x00,0x00,/*"僑",1*/

0x00,0x00,0x00,0x40,0x40,0x40,0xFE,0x20,0x20,0x20,0x20,0x00,0x00,0x00,0x00,0x00,
0x00,0x10,0x08,0x06,0x01,0x01,0x06,0x0C,0x08,0x10,0x00,0x00,/*"大",2*/

0x00,0xC0,0x40,0x4C,0x3A,0xAA,0xB4,0xDE,0x2A,0x1E,0x62,0x20,0x00,0x00,0x00,0x00,
0x02,0x02,0x02,0x12,0x1F,0x01,0x01,0x01,0x01,0x00,0x00,0x00,/*"學",3*/
...
void CCD_display(uint8 num)  //OLED显示CCD程序
{      
  LCD_Fill(0x00);//清屏
  uint8 i,tempCCD[128];
  if(num==1)
  ...
  for(i=0;i<128;i++)
  {
    tempCCD[i]=ccd1.CCD_BUFF[i]/2;
    if(tempCCD[i]>=63) 
      tempCCD[i]=63;
  }
  for(i=0;i<128;i++)  
  {
     LCD_PutPixel(i,tempCCD[i]);
    LED_PrintValueF(60,0,1,1);
  }
  }
   if(num==2)
  {
